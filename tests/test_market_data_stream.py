...
def _snapshot(*, instrument_id: str = "NSE:RELIANCE", source_id: str = "paper-feed-1", minute: int = 0, price: str = "2500") -> PaperMarketDataSnapshot:
...
@pytest.mark.parametrize(("instrument_id", "source_id"), [("", "paper-feed-1"), ("NSE:RELIANCE", "")])
